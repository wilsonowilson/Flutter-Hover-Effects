...
class FlutterCuberto extends StatefulWidget {
  @override
  _FlutterCubertoState createState() => _FlutterCubertoState();
}

class _FlutterCubertoState extends State<FlutterCuberto>
  ...
  String selectedAsset = 'assets/images/one.gif';
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: Scaffold(
        backgroundColor: Color.fromRGBO(10, 10, 20, 1),
                            ...
                            child: Transform.scale(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [],
                                  color:
                                      pointerScale <= 1 ? Colors.white : null,
                  ...
                  children: [
                    HoverColumn(
                      ...
                      onColumnHover: (e) {
                        firstScale(e);
                        setState(
                          () => selectedAsset = 'assets/images/one.gif',
                        );
                      },
                    ),
                    HoverColumn(
                      ...
                      onColumnHover: (e) {
                        firstScale(e);
                        setState(
                          () => selectedAsset = 'assets/images/three.gif',
                        );
                      },
                    ),
                    HoverColumn(
                      ...
                      onColumnHover: (e) {
                        firstScale(e);
                        setState(
                          () => selectedAsset = 'assets/images/two.gif',
                        );
                      },
                    ),
                  ],
              ...
              child: BlendMask(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: isHoveringOverText ? Colors.white : Colors.white,
                  ),
                ),
              ),
            ),
